UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/11-52-04.811_mkngff/619bc279-6868-4aa5-998b-7da9dbb6c04e.zarr' where image in (select id from Image where fileset = 6314132);
