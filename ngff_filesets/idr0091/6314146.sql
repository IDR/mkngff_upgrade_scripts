UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/18-04-10.558_mkngff/58928f87-6436-4e5a-8c31-cce66c46db80.zarr' where image in (select id from Image where fileset = 6314146);
