UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/02/18-31-36.156_mkngff/900f0270-04a7-4969-8bc1-06d0cf820e2e.zarr' where image in (select id from Image where fileset = 4053182);
