UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/03/10-58-51.350_mkngff/3487de22-5b85-46f9-b01e-99bae1b366da.zarr' where image in (select id from Image where fileset = 4053443);
