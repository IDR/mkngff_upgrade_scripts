UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/06-54-16.848_mkngff/9f46b3a6-c3dd-42c3-a1fe-f313283c199f.zarr' where image in (select id from Image where fileset = 6314199);
