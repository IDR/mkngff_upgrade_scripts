UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/16-25-44.044_mkngff/8b552621-8d78-4819-832e-9779d9e4f8ad.zarr' where image in (select id from Image where fileset = 4053805);
