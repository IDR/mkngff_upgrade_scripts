UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/16-06-20.949_mkngff/5de66988-91c1-49b9-86d9-48bcd38da43e.zarr' where image in (select id from Image where fileset = 6314104);
