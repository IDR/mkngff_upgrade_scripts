UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/03/13-30-18.281_mkngff/dbcae661-7b8e-4eef-a280-b098d25a3c9f.zarr' where image in (select id from Image where fileset = 4053489);
