UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/16-35-16.861_mkngff/1e7d257b-f215-4839-8940-8bbf16841cee.zarr' where image in (select id from Image where fileset = 4053809);
