UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/02-27-09.895_mkngff/e7a38083-96ce-46e6-bbcc-d7367eb7576a.zarr' where image in (select id from Image where fileset = 4053350);
