UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/02/14-41-08.138_mkngff/f3e6bdaf-ef2e-447f-ad2d-45381621de23.zarr' where image in (select id from Image where fileset = 4053140);
