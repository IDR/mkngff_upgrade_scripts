UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/06-33-46.339_mkngff/eafd8356-c48f-4cd2-aa4e-f8df9018b50c.zarr' where image in (select id from Image where fileset = 6314358);
