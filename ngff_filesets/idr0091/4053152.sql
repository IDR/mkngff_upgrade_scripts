UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/02/15-43-39.699_mkngff/8bac8eed-8573-4050-8131-94e65aa64aa0.zarr' where image in (select id from Image where fileset = 4053152);
