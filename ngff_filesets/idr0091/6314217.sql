UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/17-38-04.761_mkngff/7bbd1999-630f-4a35-800a-fef7b1fd1a83.zarr' where image in (select id from Image where fileset = 6314217);
