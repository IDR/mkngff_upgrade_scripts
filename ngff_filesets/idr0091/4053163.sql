UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-13/2020-10/02/16-45-54.346_mkngff/3809e092-8094-4ddd-aa10-b795b3467682.zarr' where image in (select id from Image where fileset = 4053163);
