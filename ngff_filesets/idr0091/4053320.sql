UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/02/23-27-04.320_mkngff/865f5a37-4d92-4c83-82e9-92fa4cdaec3e.zarr' where image in (select id from Image where fileset = 4053320);
