UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/02/17-56-37.848_mkngff/e08bebd5-774f-4d06-bf69-47c94f4d88cc.zarr' where image in (select id from Image where fileset = 4053176);
