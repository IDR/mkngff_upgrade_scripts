UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/12-45-55.193_mkngff/1eecc9b6-042e-4eb5-8abf-a02b5a3ab768.zarr' where image in (select id from Image where fileset = 4053481);
