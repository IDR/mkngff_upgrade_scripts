UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/14-20-21.343_mkngff/63f8eb58-5e1e-485b-b158-8faa58b25148.zarr' where image in (select id from Image where fileset = 4053498);
