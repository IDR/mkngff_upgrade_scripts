UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/12-06-21.783_mkngff/a34302b4-4946-4efe-91ad-893490fe2321.zarr' where image in (select id from Image where fileset = 4053467);
