UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/03/03-06-45.334_mkngff/8ddc8f41-4e6b-47f8-b9d9-83a1f0576da0.zarr' where image in (select id from Image where fileset = 4053356);
