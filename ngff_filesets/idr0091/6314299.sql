UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/14-53-54.286_mkngff/3d0a55c1-4f58-4db1-9837-abcb590fe0aa.zarr' where image in (select id from Image where fileset = 6314299);
