UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/02/19-04-19.322_mkngff/c413967a-b146-4f41-a898-5122055924f1.zarr' where image in (select id from Image where fileset = 6314113);
