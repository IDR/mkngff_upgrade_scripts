UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/17-21-08.652_mkngff/35646b9a-6e05-4a54-83df-da92b3a78c60.zarr' where image in (select id from Image where fileset = 6314388);
