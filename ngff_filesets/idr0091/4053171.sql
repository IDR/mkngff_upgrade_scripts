UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-16/2020-10/02/17-28-44.876_mkngff/b2028f92-d549-412b-87cc-892b39a39d2f.zarr' where image in (select id from Image where fileset = 4053171);
