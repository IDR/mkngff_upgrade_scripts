UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/03/04-20-05.333_mkngff/e24d4909-32a8-4762-9343-87375ed223d5.zarr' where image in (select id from Image where fileset = 6314170);
