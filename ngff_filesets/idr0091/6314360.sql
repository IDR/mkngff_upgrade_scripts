UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/02/23-44-16.033_mkngff/56f63893-0425-4014-bd3e-be42d1d31eb4.zarr' where image in (select id from Image where fileset = 6314360);
