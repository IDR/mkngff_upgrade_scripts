UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/13-01-57.662_mkngff/c1927d44-5dc1-4ad1-9864-5ba4d92f0690.zarr' where image in (select id from Image where fileset = 4053484);
