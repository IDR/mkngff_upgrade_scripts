UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/17-18-34.848_mkngff/0298896b-c407-4004-88e5-202c9904a717.zarr' where image in (select id from Image where fileset = 6314286);
