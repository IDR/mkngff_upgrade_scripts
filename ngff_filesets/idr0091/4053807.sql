UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/16-30-36.728_mkngff/ca6378b9-03d6-478d-b469-a370b7504ca1.zarr' where image in (select id from Image where fileset = 4053807);
