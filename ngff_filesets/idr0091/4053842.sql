UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/17-54-38.862_mkngff/ac6f4c99-d47c-410a-a512-fb63bcc7ea03.zarr' where image in (select id from Image where fileset = 4053842);
