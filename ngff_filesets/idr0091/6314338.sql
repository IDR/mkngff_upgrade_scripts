UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/17-42-48.836_mkngff/5b380ba4-0bd7-4625-b2da-5fb10db9ef3c.zarr' where image in (select id from Image where fileset = 6314338);
