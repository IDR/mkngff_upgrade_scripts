UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/02/16-35-51.773_mkngff/46cd6ff1-f928-4db1-9e89-70b51b64ba91.zarr' where image in (select id from Image where fileset = 6314122);
