UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/08-24-40.211_mkngff/a7c0e9db-874f-45b5-8fe9-e3457092ab49.zarr' where image in (select id from Image where fileset = 4053400);
