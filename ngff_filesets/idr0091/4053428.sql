UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/09-54-41.529_mkngff/b2382eb4-de0c-4375-a50a-0beedb5358b5.zarr' where image in (select id from Image where fileset = 4053428);
