UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/12-32-23.967_mkngff/b119cf78-e9ec-4b6b-a46c-f6d4ed425bf8.zarr' where image in (select id from Image where fileset = 4053476);
