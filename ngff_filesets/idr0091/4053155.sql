UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/02/16-00-30.648_mkngff/78475303-dc75-4dde-8a92-80df6eaff750.zarr' where image in (select id from Image where fileset = 4053155);
