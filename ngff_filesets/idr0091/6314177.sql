UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/06-25-49.733_mkngff/89088acc-7b4b-4024-8215-a4bcc55de57e.zarr' where image in (select id from Image where fileset = 6314177);
