UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/02-53-05.128_mkngff/434f433d-14bb-4fa5-95b6-fe788504df50.zarr' where image in (select id from Image where fileset = 4053354);
