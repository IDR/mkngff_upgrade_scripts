UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/12-29-29.549_mkngff/cedb9f66-05c1-4269-b140-77261d497086.zarr' where image in (select id from Image where fileset = 4053475);
