UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/11-21-41.985_mkngff/663ac2a1-7fc9-47da-a1b2-4bc0a7849b47.zarr' where image in (select id from Image where fileset = 4053451);
