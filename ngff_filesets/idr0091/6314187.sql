UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/13-12-42.671_mkngff/7d700451-5a85-4104-8126-dd797bf3f380.zarr' where image in (select id from Image where fileset = 6314187);
