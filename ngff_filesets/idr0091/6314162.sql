UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/02/22-55-19.692_mkngff/ca137515-a18b-47c1-ad88-423baf46a80c.zarr' where image in (select id from Image where fileset = 6314162);
