UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/01-56-03.946_mkngff/a9ad96c0-1c60-43c6-8df2-d18fea1370ac.zarr' where image in (select id from Image where fileset = 6314151);
