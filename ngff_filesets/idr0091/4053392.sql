UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-16/2020-10/03/07-28-01.497_mkngff/04c7fbbc-3c48-47d0-b791-e754c157321b.zarr' where image in (select id from Image where fileset = 4053392);
