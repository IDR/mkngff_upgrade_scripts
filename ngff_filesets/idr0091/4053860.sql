UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/18-36-54.615_mkngff/0ffef313-b426-4b3a-ab76-0881ce7f54a4.zarr' where image in (select id from Image where fileset = 4053860);
