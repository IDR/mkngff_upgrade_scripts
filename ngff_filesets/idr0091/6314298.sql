UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/05-28-05.140_mkngff/62825e63-b124-417a-a3c7-9583cf063983.zarr' where image in (select id from Image where fileset = 6314298);
