UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/12-35-21.741_mkngff/0d78d192-5ecf-4cf5-a190-d8fb13d86e95.zarr' where image in (select id from Image where fileset = 6314210);
