UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/03/00-23-46.614_mkngff/abf804e3-870f-4f99-b088-16696ff806bd.zarr' where image in (select id from Image where fileset = 6314160);
