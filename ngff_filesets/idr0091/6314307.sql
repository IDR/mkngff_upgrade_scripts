UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/02-33-13.995_mkngff/38caada9-38e5-4050-9fb2-c047ed10c19a.zarr' where image in (select id from Image where fileset = 6314307);
