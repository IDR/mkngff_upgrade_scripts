UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/06-47-39.547_mkngff/4e16bfec-b350-4e4e-a32d-6ed90b21c173.zarr' where image in (select id from Image where fileset = 6314396);
