UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/09-59-06.033_mkngff/48323363-e08d-479e-9a9a-efd10bc2cd96.zarr' where image in (select id from Image where fileset = 4053429);
