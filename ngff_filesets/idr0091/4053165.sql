UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/02/16-55-37.452_mkngff/9edfe9d8-8f50-4ed4-9806-bea9d01ca8fa.zarr' where image in (select id from Image where fileset = 4053165);
