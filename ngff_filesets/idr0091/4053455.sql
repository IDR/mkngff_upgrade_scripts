UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/11-32-48.457_mkngff/71cc40c5-1d0e-4645-be06-a119abf660b2.zarr' where image in (select id from Image where fileset = 4053455);
