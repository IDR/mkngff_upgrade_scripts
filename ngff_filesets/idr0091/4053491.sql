UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/13-41-01.123_mkngff/b5c35cec-4493-45c1-82fb-6e07b8378bf0.zarr' where image in (select id from Image where fileset = 4053491);
