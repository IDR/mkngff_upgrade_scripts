UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/16-18-19.710_mkngff/d2404aae-79e3-4a6f-93b1-40d1ab2103cc.zarr' where image in (select id from Image where fileset = 6314189);
