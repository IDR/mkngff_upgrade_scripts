UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/13-52-51.574_mkngff/5a9ffa6c-11fa-46c6-8e92-f0364d22362e.zarr' where image in (select id from Image where fileset = 6314168);
