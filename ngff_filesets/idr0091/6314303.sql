UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/02/21-33-19.956_mkngff/51a27e30-da5a-41eb-bacb-62268c645166.zarr' where image in (select id from Image where fileset = 6314303);
