UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/17-23-33.475_mkngff/d81b320c-6f47-4577-8a47-fafa926defe8.zarr' where image in (select id from Image where fileset = 6314312);
