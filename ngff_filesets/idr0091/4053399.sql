UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/08-16-48.279_mkngff/45e06f3e-99be-4966-81b3-ad2007dc0b54.zarr' where image in (select id from Image where fileset = 4053399);
