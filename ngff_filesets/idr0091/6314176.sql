UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-16/2020-10/03/11-54-52.205_mkngff/63abc8a9-160f-43b4-ac4f-18d3c5e5d26f.zarr' where image in (select id from Image where fileset = 6314176);
