UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/17-16-16.089_mkngff/d502b246-44b2-4711-897f-a1051c7957a3.zarr' where image in (select id from Image where fileset = 6314198);
