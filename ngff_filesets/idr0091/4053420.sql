UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/09-20-19.424_mkngff/637c30ca-e05f-427b-ac14-dfbfcc33fa33.zarr' where image in (select id from Image where fileset = 4053420);
