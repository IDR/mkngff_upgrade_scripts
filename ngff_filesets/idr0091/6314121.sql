UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/02/15-07-11.449_mkngff/155cc17a-785e-4ffa-963b-ce911c4977f5.zarr' where image in (select id from Image where fileset = 6314121);
