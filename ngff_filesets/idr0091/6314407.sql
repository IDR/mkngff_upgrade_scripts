UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/09-46-05.759_mkngff/4fd704e9-061f-4f18-b442-b36ce1797007.zarr' where image in (select id from Image where fileset = 6314407);
