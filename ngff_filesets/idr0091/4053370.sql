UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/04-53-48.297_mkngff/8de7e317-f89c-41cd-bcc3-f1dc1312e83c.zarr' where image in (select id from Image where fileset = 4053370);
