UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-22/2020-10/03/10-32-54.401_mkngff/9c103eb2-82f8-4ea6-b8bf-8d13f961a9f1.zarr' where image in (select id from Image where fileset = 4053437);
