UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/16-11-13.247_mkngff/0291afc9-e103-4ac0-83f4-785fa61c9ee9.zarr' where image in (select id from Image where fileset = 6314371);
