UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/12-56-39.380_mkngff/8a1929be-a7cb-4e13-8b24-857e2e139874.zarr' where image in (select id from Image where fileset = 6314096);
