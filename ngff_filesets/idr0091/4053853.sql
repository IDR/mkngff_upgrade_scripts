UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-22/2020-10/03/18-20-29.670_mkngff/1ccb01a8-2693-419f-af34-772bda591f7e.zarr' where image in (select id from Image where fileset = 4053853);
