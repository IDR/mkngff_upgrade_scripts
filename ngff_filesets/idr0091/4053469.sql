UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/12-11-57.839_mkngff/85c39ff9-b0b4-44fc-b378-b25701798c3b.zarr' where image in (select id from Image where fileset = 4053469);
