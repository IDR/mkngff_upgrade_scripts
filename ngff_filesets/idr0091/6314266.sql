UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/02-21-15.332_mkngff/5dc05842-7bfd-4386-bf26-d658044f3baf.zarr' where image in (select id from Image where fileset = 6314266);
