UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/02/22-37-00.250_mkngff/35098780-25b3-40d1-920d-f701283bf6a6.zarr' where image in (select id from Image where fileset = 6314201);
