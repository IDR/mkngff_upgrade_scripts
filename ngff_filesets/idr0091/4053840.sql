UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-13/2020-10/03/17-49-36.880_mkngff/82242c18-a61f-42e3-994d-a625b3e8b657.zarr' where image in (select id from Image where fileset = 4053840);
