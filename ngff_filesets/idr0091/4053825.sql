UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/17-13-52.941_mkngff/41e9864a-2bf1-479e-8e12-ab2e78704e6d.zarr' where image in (select id from Image where fileset = 4053825);
