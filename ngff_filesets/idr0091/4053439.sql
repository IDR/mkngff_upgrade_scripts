UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/10-42-25.303_mkngff/4816856b-6d56-45f3-ac47-0eb26b2a98bb.zarr' where image in (select id from Image where fileset = 4053439);
