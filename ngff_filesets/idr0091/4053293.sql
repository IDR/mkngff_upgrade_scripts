UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/02/20-54-35.702_mkngff/1ae9989d-e94e-4f79-9a21-8cae60d655cf.zarr' where image in (select id from Image where fileset = 4053293);
