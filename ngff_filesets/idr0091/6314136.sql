UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/00-00-45.180_mkngff/33a654a5-69c8-4848-97dc-d194a5779c08.zarr' where image in (select id from Image where fileset = 6314136);
