UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/15-57-18.682_mkngff/5aa09f60-fa7f-4285-8e16-c0bdf4e69b3f.zarr' where image in (select id from Image where fileset = 4053793);
