UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/16-46-45.036_mkngff/02fc9189-ee03-4431-8fb1-2d1d592a0900.zarr' where image in (select id from Image where fileset = 4053814);
