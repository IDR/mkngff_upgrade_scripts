UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/02/16-24-35.242_mkngff/5a060279-3e71-4f4e-ad3b-3dc0098d21e3.zarr' where image in (select id from Image where fileset = 4053159);
