UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/02/22-49-33.618_mkngff/c3e4e0b4-9ed1-4702-80e6-9c308ac5720a.zarr' where image in (select id from Image where fileset = 6314158);
