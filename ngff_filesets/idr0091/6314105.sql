UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/14-25-57.022_mkngff/b19a5a40-71a8-47df-a4d8-e247e7a1f964.zarr' where image in (select id from Image where fileset = 6314105);
