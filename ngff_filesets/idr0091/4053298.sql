UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/02/21-21-56.236_mkngff/f97cb837-2c4f-4a7c-96ca-0ee6c3bccd50.zarr' where image in (select id from Image where fileset = 4053298);
