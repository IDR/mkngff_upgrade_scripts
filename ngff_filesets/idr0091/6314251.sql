UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/02/18-59-03.170_mkngff/a1893a7e-9433-4d60-a554-87c513dac7dd.zarr' where image in (select id from Image where fileset = 6314251);
