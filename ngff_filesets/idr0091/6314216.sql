UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-13/2020-10/03/18-41-44.754_mkngff/4fb81744-7a2b-4805-993d-3c280231a609.zarr' where image in (select id from Image where fileset = 6314216);
