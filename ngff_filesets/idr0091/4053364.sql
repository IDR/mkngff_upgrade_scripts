UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/03/03-59-38.381_mkngff/d24afd86-a85c-4036-a559-52532c5e12e8.zarr' where image in (select id from Image where fileset = 4053364);
