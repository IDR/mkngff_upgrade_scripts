UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/02/17-51-25.958_mkngff/be51438c-c14e-4680-a23d-3748e835e9cc.zarr' where image in (select id from Image where fileset = 4053175);
