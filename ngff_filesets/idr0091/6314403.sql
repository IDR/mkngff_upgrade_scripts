UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-13/2020-10/03/14-37-43.042_mkngff/c5280a53-c981-4acb-b4d5-77d144c6e77c.zarr' where image in (select id from Image where fileset = 6314403);
