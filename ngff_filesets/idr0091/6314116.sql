UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/05-14-42.492_mkngff/aba38bcd-9645-4fe0-9b47-b4206cf56b67.zarr' where image in (select id from Image where fileset = 6314116);
