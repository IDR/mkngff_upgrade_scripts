UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/02/21-00-05.480_mkngff/4a7a9d93-f084-49e4-9e8c-3d7308164e43.zarr' where image in (select id from Image where fileset = 6314134);
