UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/00-51-43.925_mkngff/8a01eafa-fe64-4510-b061-5e0b2d58258a.zarr' where image in (select id from Image where fileset = 4053335);
