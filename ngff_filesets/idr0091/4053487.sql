UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/13-19-06.275_mkngff/431400c7-fe10-4dc5-91d5-461736c02811.zarr' where image in (select id from Image where fileset = 4053487);
