UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/05-43-00.200_mkngff/e5c1c98b-545b-4b6e-ae79-55197391d78b.zarr' where image in (select id from Image where fileset = 4053377);
