UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/03/03-27-42.872_mkngff/a5acd849-ea6c-4e24-9540-68c83e0340c1.zarr' where image in (select id from Image where fileset = 4053359);
