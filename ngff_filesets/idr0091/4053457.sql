UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/11-38-18.315_mkngff/dabdde88-7a4f-46dd-b03b-6a29ab6dc724.zarr' where image in (select id from Image where fileset = 4053457);
