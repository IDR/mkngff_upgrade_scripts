UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/14-03-43.588_mkngff/c304078e-d015-4381-816d-2c6ea945a2ba.zarr' where image in (select id from Image where fileset = 6314293);
