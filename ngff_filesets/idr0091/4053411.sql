UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/08-39-46.160_mkngff/f6b12e5c-a7c9-4383-b358-e3bd4554639d.zarr' where image in (select id from Image where fileset = 4053411);
