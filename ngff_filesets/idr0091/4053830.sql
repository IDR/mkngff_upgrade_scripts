UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/17-25-49.312_mkngff/b8492d2f-0090-434a-876f-0d6244df213b.zarr' where image in (select id from Image where fileset = 4053830);
