UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/12-38-02.809_mkngff/21ccf24b-15e4-445a-90f8-83ef33b3193a.zarr' where image in (select id from Image where fileset = 6314386);
