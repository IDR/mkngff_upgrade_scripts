UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-16/2020-10/02/17-00-39.165_mkngff/0be49fe7-1902-4abd-a8fa-babb0f1f0ec7.zarr' where image in (select id from Image where fileset = 4053166);
