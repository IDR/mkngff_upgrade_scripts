UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/11-40-50.815_mkngff/1eccd3bf-2ada-40d7-bca1-a0cfb993e5d8.zarr' where image in (select id from Image where fileset = 4053458);
