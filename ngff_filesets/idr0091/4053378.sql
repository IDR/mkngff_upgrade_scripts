UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/03/05-49-58.992_mkngff/76a328de-067d-40f6-b4af-b8474c6c5e26.zarr' where image in (select id from Image where fileset = 4053378);
