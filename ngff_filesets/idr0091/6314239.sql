UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/18-39-11.489_mkngff/7e1adfd6-86c5-400a-8b5a-99e2346ed0d7.zarr' where image in (select id from Image where fileset = 6314239);
