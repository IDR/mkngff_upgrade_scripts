UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/16-56-37.519_mkngff/80742e73-27c3-408a-8a80-3ce5271da0d2.zarr' where image in (select id from Image where fileset = 4053818);
