UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-16/2020-10/02/20-43-55.030_mkngff/fc41d036-420a-4aab-ace9-e80aefebd97b.zarr' where image in (select id from Image where fileset = 6314129);
