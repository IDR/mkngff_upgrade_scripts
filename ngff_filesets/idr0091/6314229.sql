UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/03/16-39-41.787_mkngff/374ac794-0a75-4a4d-b649-1b7f619ed809.zarr' where image in (select id from Image where fileset = 6314229);
