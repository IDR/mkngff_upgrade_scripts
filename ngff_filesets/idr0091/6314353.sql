UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/18-34-48.347_mkngff/19b3b2e8-0b8a-429c-be3c-8a6f3364edee.zarr' where image in (select id from Image where fileset = 6314353);
