UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/03/08-03-47.641_mkngff/e7aa4811-3cca-464e-bb6b-65712fb9c261.zarr' where image in (select id from Image where fileset = 4053397);
