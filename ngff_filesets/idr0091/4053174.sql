UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/02/17-45-46.288_mkngff/729c34f5-fb6d-4025-a8e5-9765559d946e.zarr' where image in (select id from Image where fileset = 4053174);
