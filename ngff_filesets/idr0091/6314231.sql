UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/10-15-58.155_mkngff/e70ea3e9-2427-4c16-a476-d507cf0bfba6.zarr' where image in (select id from Image where fileset = 6314231);
