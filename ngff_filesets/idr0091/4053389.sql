UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/07-07-12.956_mkngff/0aa2eac0-d7e0-4755-a708-aa419e67e597.zarr' where image in (select id from Image where fileset = 4053389);
