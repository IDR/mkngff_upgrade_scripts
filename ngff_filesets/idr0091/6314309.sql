UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/11-35-45.043_mkngff/c22d1245-9b01-4ad7-a230-ba3b57975378.zarr' where image in (select id from Image where fileset = 6314309);
