UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/07-14-23.014_mkngff/67b3856c-e5b2-4ca1-9f4e-449cf6627953.zarr' where image in (select id from Image where fileset = 4053390);
