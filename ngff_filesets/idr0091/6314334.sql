UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/02/17-11-44.019_mkngff/a453ba20-1628-4bb4-81a9-a2621bff6bd8.zarr' where image in (select id from Image where fileset = 6314334);
