UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/18-08-59.896_mkngff/dfcc8bcf-9d1a-4985-aa02-ad7a8e7b8629.zarr' where image in (select id from Image where fileset = 6314399);
