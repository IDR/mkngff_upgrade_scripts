UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/03/01-49-28.641_mkngff/1e9f167b-128f-4aa7-97a4-c7167cd3f508.zarr' where image in (select id from Image where fileset = 6314118);
