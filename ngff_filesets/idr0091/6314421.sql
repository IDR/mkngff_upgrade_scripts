UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/02/22-12-44.903_mkngff/d284fea6-8193-446e-9990-d1ea9f50d4aa.zarr' where image in (select id from Image where fileset = 6314421);
