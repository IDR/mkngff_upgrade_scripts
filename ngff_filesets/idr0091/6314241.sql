UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/02-39-35.637_mkngff/7e5f212b-bb2b-413b-ae83-056935436118.zarr' where image in (select id from Image where fileset = 6314241);
