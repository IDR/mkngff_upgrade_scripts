UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/02-15-11.470_mkngff/73651cea-bef3-43f8-9159-010a612b53fb.zarr' where image in (select id from Image where fileset = 4053348);
