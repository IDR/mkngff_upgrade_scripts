UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/02/22-02-11.564_mkngff/66420be2-c7b1-41ec-b4c1-d309f7722e11.zarr' where image in (select id from Image where fileset = 4053305);
