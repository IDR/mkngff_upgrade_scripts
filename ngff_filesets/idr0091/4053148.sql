UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/02/15-22-37.978_mkngff/6c4e1d9d-2d1d-47b2-8528-b881e4aac215.zarr' where image in (select id from Image where fileset = 4053148);
