UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-16/2020-10/03/17-33-14.991_mkngff/6e9e3255-501e-4c26-be1f-9249db7eb2ac.zarr' where image in (select id from Image where fileset = 4053833);
