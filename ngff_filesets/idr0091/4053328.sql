UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/03/00-12-09.061_mkngff/512fc572-7265-4b58-9fb0-b0f9ea589530.zarr' where image in (select id from Image where fileset = 4053328);
