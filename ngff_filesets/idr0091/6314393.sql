UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-13/2020-10/02/19-43-26.720_mkngff/d6d0169d-1f9d-400e-ab7e-a1bae5218ec6.zarr' where image in (select id from Image where fileset = 6314393);
