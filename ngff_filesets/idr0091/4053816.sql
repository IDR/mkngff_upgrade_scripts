UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/16-51-45.455_mkngff/0c245b24-a0f9-4e3b-9f42-cd026512f515.zarr' where image in (select id from Image where fileset = 4053816);
