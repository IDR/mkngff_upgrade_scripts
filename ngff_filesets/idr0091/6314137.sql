UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/02-09-06.966_mkngff/93ec4261-e34d-422f-9b90-51f96717baf9.zarr' where image in (select id from Image where fileset = 6314137);
