UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/03/02-46-01.706_mkngff/40c8d343-463f-4aa9-8f7f-452172361c6e.zarr' where image in (select id from Image where fileset = 4053353);
