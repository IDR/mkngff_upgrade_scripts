UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/04-47-34.903_mkngff/91eda3e5-1e55-46d9-9ffc-7e5326b88b86.zarr' where image in (select id from Image where fileset = 4053369);
