UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/02/19-25-07.320_mkngff/ec898516-dc13-4e80-9a26-7c42a67fb437.zarr' where image in (select id from Image where fileset = 6314153);
