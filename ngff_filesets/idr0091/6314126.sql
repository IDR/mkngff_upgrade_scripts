UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/04-38-36.794_mkngff/ef8ec513-f66f-468b-9213-f80885b265b0.zarr' where image in (select id from Image where fileset = 6314126);
