UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/04-30-14.481_mkngff/e5adc23f-eb11-405a-ba6a-49e79659f74d.zarr' where image in (select id from Image where fileset = 6314409);
