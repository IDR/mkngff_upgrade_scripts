UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/02/19-32-48.863_mkngff/fa1ce860-40b8-473f-9cf0-845533b9c7c7.zarr' where image in (select id from Image where fileset = 4053193);
