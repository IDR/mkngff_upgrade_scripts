UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/02/18-13-56.602_mkngff/3926080c-ceba-49f1-bd01-666b35a5b79b.zarr' where image in (select id from Image where fileset = 4053179);
