UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-22/2020-10/03/13-24-40.641_mkngff/76c6cd3e-1499-4dfe-8b7a-5d27cf93c547.zarr' where image in (select id from Image where fileset = 4053488);
