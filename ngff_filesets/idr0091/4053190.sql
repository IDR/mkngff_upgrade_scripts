UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/02/19-14-48.658_mkngff/c2d3a4e9-5ec5-4fef-b549-e905b689697c.zarr' where image in (select id from Image where fileset = 4053190);
