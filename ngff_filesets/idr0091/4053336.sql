UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/00-57-19.337_mkngff/2bcbb32a-8094-423f-910d-3d4536cd2892.zarr' where image in (select id from Image where fileset = 4053336);
