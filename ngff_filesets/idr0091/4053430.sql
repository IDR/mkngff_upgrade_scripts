UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/03/10-03-05.277_mkngff/7cb20b6f-e404-424d-a8b4-81f05244d71e.zarr' where image in (select id from Image where fileset = 4053430);
