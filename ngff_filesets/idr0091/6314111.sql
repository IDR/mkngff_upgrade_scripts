UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/02/23-00-58.921_mkngff/7b2b58f5-363e-4dec-954c-7d03dc7998fa.zarr' where image in (select id from Image where fileset = 6314111);
