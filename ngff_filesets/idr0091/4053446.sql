UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/03/11-06-58.196_mkngff/4a5efa45-8cb7-45ba-b51d-b2adae2ce769.zarr' where image in (select id from Image where fileset = 4053446);
