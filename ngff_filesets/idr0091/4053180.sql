UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/02/18-19-48.580_mkngff/f4765f98-d6ef-4bc3-aaae-a6cecef9505f.zarr' where image in (select id from Image where fileset = 4053180);
