UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/03/18-46-42.952_mkngff/25884d0a-05db-44f7-99d5-e3e40e84e917.zarr' where image in (select id from Image where fileset = 4053864);
