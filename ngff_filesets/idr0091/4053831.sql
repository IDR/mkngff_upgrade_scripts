UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/03/17-28-24.941_mkngff/b472d5c5-7caf-4f29-9758-b68c72ee0d40.zarr' where image in (select id from Image where fileset = 4053831);
