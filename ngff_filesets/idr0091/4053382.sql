UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/06-18-55.324_mkngff/5db4d43e-b7ac-4ea7-a7d9-cb79c8b260b4.zarr' where image in (select id from Image where fileset = 4053382);
