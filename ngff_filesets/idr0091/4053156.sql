UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/02/16-06-40.516_mkngff/03f2af95-e49c-4a87-9d89-1e69ab0317ee.zarr' where image in (select id from Image where fileset = 4053156);
