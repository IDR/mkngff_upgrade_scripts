UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/02/15-28-40.355_mkngff/0385da0d-a946-4c08-b605-4bd4f1429211.zarr' where image in (select id from Image where fileset = 6314268);
