UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/10-11-46.554_mkngff/a32e6b57-d7c0-4fcd-9baf-f7fea8af7dce.zarr' where image in (select id from Image where fileset = 6314131);
