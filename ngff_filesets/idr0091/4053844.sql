UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/17-59-33.707_mkngff/830fee81-3fb7-4924-ba9a-27b3039e8db7.zarr' where image in (select id from Image where fileset = 4053844);
