UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/16-37-29.652_mkngff/833b3a39-ea0f-46e3-b92f-8c96f8c93db6.zarr' where image in (select id from Image where fileset = 6314125);
