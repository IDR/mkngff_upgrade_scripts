UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/16-01-45.027_mkngff/57ecadba-7a84-4b09-ba07-045625663547.zarr' where image in (select id from Image where fileset = 4053795);
