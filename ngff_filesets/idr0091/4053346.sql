UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/02-02-34.667_mkngff/2200b2b6-6dfc-405b-81ef-4618b5d7ffb2.zarr' where image in (select id from Image where fileset = 4053346);
