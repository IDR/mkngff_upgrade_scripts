UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/03/18-13-19.250_mkngff/bbffa659-b902-4680-a5f9-a3646b2db4fe.zarr' where image in (select id from Image where fileset = 4053850);
