UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/03-00-16.460_mkngff/9f76a6eb-d166-4c85-9c01-d9c61cd3226b.zarr' where image in (select id from Image where fileset = 4053355);
