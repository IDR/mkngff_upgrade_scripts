UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/17-47-15.339_mkngff/377b0a96-cbae-4e2c-8b1e-bab5e517f6de.zarr' where image in (select id from Image where fileset = 6314432);
