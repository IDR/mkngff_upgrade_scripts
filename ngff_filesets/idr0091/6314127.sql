UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/17-06-17.446_mkngff/c583840f-021d-488d-9d6b-3df579c171d2.zarr' where image in (select id from Image where fileset = 6314127);
