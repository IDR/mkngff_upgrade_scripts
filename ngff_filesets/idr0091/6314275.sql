UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-13/2020-10/03/11-46-26.406_mkngff/d0f4f4a3-c0ee-4059-b89d-48fa95cea556.zarr' where image in (select id from Image where fileset = 6314275);
