UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/02/23-20-11.893_mkngff/234c8055-22a2-43be-b0e7-87ef8729a8f6.zarr' where image in (select id from Image where fileset = 4053319);
