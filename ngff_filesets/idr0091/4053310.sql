UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/02/22-28-56.835_mkngff/bbae67aa-bfaa-41b5-9243-f53d0784c9c7.zarr' where image in (select id from Image where fileset = 4053310);
