UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-13/2020-10/03/01-15-36.184_mkngff/9fb72665-934b-4043-9e5c-4e3ca257400a.zarr' where image in (select id from Image where fileset = 4053339);
