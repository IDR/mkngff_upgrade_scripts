UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/02/23-33-31.528_mkngff/7592cd21-0b49-4918-a0a6-ad28cd9df892.zarr' where image in (select id from Image where fileset = 4053321);
