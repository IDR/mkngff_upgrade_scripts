UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/02/15-33-34.728_mkngff/d63ed7bb-a149-4aa8-8a3e-51e3a2b3de60.zarr' where image in (select id from Image where fileset = 6314310);
