UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/12-14-42.127_mkngff/c4c9a564-e642-4f91-997e-58960c3a7fc7.zarr' where image in (select id from Image where fileset = 4053470);
