UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/18-17-56.595_mkngff/7524c60e-b100-4bc6-810a-89cbfa3e3bec.zarr' where image in (select id from Image where fileset = 6314292);
