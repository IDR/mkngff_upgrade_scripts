UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-16/2020-10/03/11-43-25.868_mkngff/53555992-3bb1-4714-8e9f-8fdee7dc1c54.zarr' where image in (select id from Image where fileset = 6314276);
