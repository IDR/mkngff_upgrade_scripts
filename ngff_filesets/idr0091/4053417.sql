UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/03/09-06-48.942_mkngff/1e4c55e1-c067-4005-bdbd-2832c1042325.zarr' where image in (select id from Image where fileset = 4053417);
