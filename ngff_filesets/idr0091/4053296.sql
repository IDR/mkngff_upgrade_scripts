UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/02/21-11-36.095_mkngff/212306b6-d18d-499a-968d-4a5a329dbd76.zarr' where image in (select id from Image where fileset = 4053296);
