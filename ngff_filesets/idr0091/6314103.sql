UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/10-37-40.202_mkngff/7ada0fdf-8295-475f-af34-e516b1797742.zarr' where image in (select id from Image where fileset = 6314103);
