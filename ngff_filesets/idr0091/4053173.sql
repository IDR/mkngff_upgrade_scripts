UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/02/17-39-55.614_mkngff/74934580-7e5a-4e54-98d9-16b49c012274.zarr' where image in (select id from Image where fileset = 4053173);
