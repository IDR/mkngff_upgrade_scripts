UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/15-59-31.052_mkngff/81012ac0-6d0a-448e-945c-e6569919700e.zarr' where image in (select id from Image where fileset = 6314387);
