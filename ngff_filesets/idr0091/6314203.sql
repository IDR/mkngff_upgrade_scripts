UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/10-07-24.922_mkngff/c762538b-0883-4983-91da-fee2ebe917f4.zarr' where image in (select id from Image where fileset = 6314203);
