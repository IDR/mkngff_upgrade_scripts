UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/02/17-06-28.627_mkngff/c1d44c13-20b0-46ef-a264-962a91f9bc5d.zarr' where image in (select id from Image where fileset = 6314406);
