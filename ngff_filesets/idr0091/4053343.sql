UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/01-42-47.127_mkngff/89b2dfc5-117a-4b71-92f1-e16a45cbd4d7.zarr' where image in (select id from Image where fileset = 4053343);
