UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/03/18-02-01.179_mkngff/9e18e0d5-8dfc-47ee-9e09-d95356dd5464.zarr' where image in (select id from Image where fileset = 6314302);
