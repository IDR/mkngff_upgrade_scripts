UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/12-26-40.852_mkngff/d02ccb4b-f07f-40e7-b635-dff2ca724d01.zarr' where image in (select id from Image where fileset = 6314306);
