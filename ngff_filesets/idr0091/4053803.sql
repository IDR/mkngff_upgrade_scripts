UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/16-20-45.887_mkngff/95dd626b-6589-428c-a3f9-949526493344.zarr' where image in (select id from Image where fileset = 4053803);
