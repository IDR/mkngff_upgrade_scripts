UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/08-53-28.854_mkngff/ccfd0968-fa8e-460f-8c40-fafe00901f21.zarr' where image in (select id from Image where fileset = 6314181);
