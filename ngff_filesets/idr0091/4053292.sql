UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/02/20-48-59.513_mkngff/54d51e15-238b-4562-9e2c-42e307f6b3c2.zarr' where image in (select id from Image where fileset = 4053292);
