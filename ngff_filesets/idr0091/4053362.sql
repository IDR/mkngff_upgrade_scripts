UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/03/03-47-27.261_mkngff/1b53d15b-4507-49f0-8a1a-02034242cb22.zarr' where image in (select id from Image where fileset = 4053362);
