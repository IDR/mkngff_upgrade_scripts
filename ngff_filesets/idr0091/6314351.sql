UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/00-29-00.121_mkngff/3063be23-cad8-4974-98d0-d28662993a0f.zarr' where image in (select id from Image where fileset = 6314351);
