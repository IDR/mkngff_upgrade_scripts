UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/02/16-30-40.943_mkngff/38e421fc-ad6f-49d8-925f-e35836eb08ce.zarr' where image in (select id from Image where fileset = 4053160);
