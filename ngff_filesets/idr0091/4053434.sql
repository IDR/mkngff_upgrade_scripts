UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/10-20-54.232_mkngff/5925d59c-9a90-4786-bb77-4f2533f814bd.zarr' where image in (select id from Image where fileset = 4053434);
