UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-22/2020-10/03/00-34-12.758_mkngff/83e93e8f-0995-46e6-8345-98c8653487dc.zarr' where image in (select id from Image where fileset = 4053332);
