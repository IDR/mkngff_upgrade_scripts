UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/03-20-06.315_mkngff/e5c9f671-8d80-490e-874d-04d6831ed9a9.zarr' where image in (select id from Image where fileset = 4053358);
