UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-13/2020-10/02/21-16-50.095_mkngff/38ab7ff8-abd6-4b04-b1c6-384052204015.zarr' where image in (select id from Image where fileset = 4053297);
