UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/02/17-34-18.898_mkngff/314c3530-26c2-476c-ae25-383f96cd5ea6.zarr' where image in (select id from Image where fileset = 4053172);
