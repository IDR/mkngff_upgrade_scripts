UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-13/2020-10/03/14-09-14.089_mkngff/ac853210-0f50-4ba7-bd1b-61d0d7470d27.zarr' where image in (select id from Image where fileset = 4053496);
