UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/18-29-59.474_mkngff/608cd490-4baa-4895-8cfe-0a898842e143.zarr' where image in (select id from Image where fileset = 4053857);
