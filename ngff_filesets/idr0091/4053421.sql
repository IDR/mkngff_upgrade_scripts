UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/09-24-34.912_mkngff/d6378cb3-c250-41a8-b209-d2cb2c2e7dff.zarr' where image in (select id from Image where fileset = 4053421);
