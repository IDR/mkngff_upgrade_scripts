UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/03/10-28-54.737_mkngff/afb58686-ba46-4891-9045-99151c492bbc.zarr' where image in (select id from Image where fileset = 6314142);
