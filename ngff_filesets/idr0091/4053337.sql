UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/01-03-03.274_mkngff/1cbcee87-49f9-438b-81bc-4ad2168e6f7e.zarr' where image in (select id from Image where fileset = 4053337);
