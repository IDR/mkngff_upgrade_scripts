UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/02/15-38-22.961_mkngff/161b2baf-865b-4d58-944f-c203a545b88f.zarr' where image in (select id from Image where fileset = 4053151);
