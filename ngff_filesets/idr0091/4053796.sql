UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/16-04-09.673_mkngff/5a62cd79-f53f-4464-8854-ab57585b0f14.zarr' where image in (select id from Image where fileset = 4053796);
