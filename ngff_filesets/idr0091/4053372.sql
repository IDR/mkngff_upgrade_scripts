UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/05-07-30.998_mkngff/1b6aee41-8e46-4596-838d-11d9f433f642.zarr' where image in (select id from Image where fileset = 4053372);
