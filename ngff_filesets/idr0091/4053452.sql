UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/03/11-24-48.543_mkngff/731df754-7a94-42c8-8dd8-cb347ef9a835.zarr' where image in (select id from Image where fileset = 4053452);
