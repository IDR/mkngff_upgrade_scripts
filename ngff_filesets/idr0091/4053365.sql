UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/04-09-30.129_mkngff/4ce43614-12e7-4139-8536-b394a6f11e09.zarr' where image in (select id from Image where fileset = 4053365);
