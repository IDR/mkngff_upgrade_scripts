UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/02/21-39-40.015_mkngff/46082488-be6b-4540-a7a2-fc81e49262d8.zarr' where image in (select id from Image where fileset = 6314430);
