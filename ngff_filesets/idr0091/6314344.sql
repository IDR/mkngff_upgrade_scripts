UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/00-40-07.244_mkngff/89256a04-74e2-439f-b29a-44eb86c2dffa.zarr' where image in (select id from Image where fileset = 6314344);
