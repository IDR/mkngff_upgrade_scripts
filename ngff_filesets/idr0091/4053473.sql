UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/12-23-47.161_mkngff/d2810778-5469-4d29-81c5-629059af442c.zarr' where image in (select id from Image where fileset = 4053473);
