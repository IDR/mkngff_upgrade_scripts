UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/15-10-31.390_mkngff/61d85002-4ab8-463b-bc34-bcb36985cc22.zarr' where image in (select id from Image where fileset = 4053507);
