UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-15/2020-10/02/23-55-32.883_mkngff/4fc6e7c8-138b-496e-8064-b91a8cfcdc59.zarr' where image in (select id from Image where fileset = 4053325);
