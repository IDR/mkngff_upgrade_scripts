UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/16-23-14.063_mkngff/84a4c565-00fb-40f7-9793-fe82f61a37bc.zarr' where image in (select id from Image where fileset = 4053804);
