UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-22/2020-10/03/01-09-36.450_mkngff/c2c4fb6c-6827-4662-b09b-c96b5cd860cd.zarr' where image in (select id from Image where fileset = 4053338);
