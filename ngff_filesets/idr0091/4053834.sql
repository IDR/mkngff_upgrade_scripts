UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-16/2020-10/03/17-35-47.556_mkngff/a775a3d5-7918-4544-985d-4da5006d15be.zarr' where image in (select id from Image where fileset = 4053834);
