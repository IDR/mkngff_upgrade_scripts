UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/02/14-57-03.867_mkngff/1ffecc36-72ba-4770-bfe8-bcdb1b94a26b.zarr' where image in (select id from Image where fileset = 6314369);
