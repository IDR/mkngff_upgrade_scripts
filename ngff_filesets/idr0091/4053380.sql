UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/06-04-38.538_mkngff/8280f6e2-6f20-4969-b473-8e2abdef2c46.zarr' where image in (select id from Image where fileset = 4053380);
