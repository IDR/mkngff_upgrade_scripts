UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/11-27-15.371_mkngff/43e18e17-c500-4a5d-a5fc-b76eea53534e.zarr' where image in (select id from Image where fileset = 6314150);
