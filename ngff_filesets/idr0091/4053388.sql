UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/07-00-44.397_mkngff/41309668-2a99-4f20-a213-5eed12151b47.zarr' where image in (select id from Image where fileset = 4053388);
