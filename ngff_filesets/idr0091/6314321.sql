UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/02/18-01-57.372_mkngff/b52afbed-1f0b-4607-8b38-98ac65de2af8.zarr' where image in (select id from Image where fileset = 6314321);
