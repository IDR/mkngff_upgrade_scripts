UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/02/15-02-19.393_mkngff/27a3b670-71cd-4c72-9d01-04abd209f84a.zarr' where image in (select id from Image where fileset = 6314117);
