UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-16/2020-10/02/21-27-32.289_mkngff/3b2af3eb-f6a9-4c69-b201-ac40b909dd2c.zarr' where image in (select id from Image where fileset = 6314326);
