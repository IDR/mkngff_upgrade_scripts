UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-16/2020-10/02/21-56-55.094_mkngff/618dde42-4f9d-4dcb-bdb8-4dba94c33249.zarr' where image in (select id from Image where fileset = 4053304);
