UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/02/15-12-06.114_mkngff/80410020-b8fa-4ccd-830c-8221a5f13a88.zarr' where image in (select id from Image where fileset = 6314110);
