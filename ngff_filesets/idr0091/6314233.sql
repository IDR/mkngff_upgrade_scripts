UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/12-00-29.603_mkngff/e1ce9151-fce1-4a29-bb2a-5f32fa21eba1.zarr' where image in (select id from Image where fileset = 6314233);
