UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-13/2020-10/02/18-53-31.163_mkngff/c7bf8faa-bf41-4102-93bd-379300a0d1fc.zarr' where image in (select id from Image where fileset = 6314161);
