UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/11-04-24.182_mkngff/d557fdf6-3e8c-48c7-8dc1-428165079f93.zarr' where image in (select id from Image where fileset = 4053445);
