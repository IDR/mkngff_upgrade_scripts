UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/09-11-38.628_mkngff/48849e40-8601-4153-9107-7877edb0fa52.zarr' where image in (select id from Image where fileset = 4053418);
