UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/02/22-42-48.835_mkngff/224f0730-8aa1-4f2e-81c7-e7d2ef43ea13.zarr' where image in (select id from Image where fileset = 6314368);
