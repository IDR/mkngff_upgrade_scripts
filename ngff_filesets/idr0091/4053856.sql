UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/03/18-27-48.640_mkngff/9071e762-09c3-451f-ada1-13b79158dfee.zarr' where image in (select id from Image where fileset = 4053856);
