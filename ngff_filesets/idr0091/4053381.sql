UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/06-11-56.431_mkngff/8cbef7ee-15f4-437e-bc29-bbb26e8ca97e.zarr' where image in (select id from Image where fileset = 4053381);
