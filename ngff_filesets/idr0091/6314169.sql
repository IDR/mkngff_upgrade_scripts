UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/14-14-49.245_mkngff/6182cd9d-5947-431a-9112-ddb02c2df11c.zarr' where image in (select id from Image where fileset = 6314169);
