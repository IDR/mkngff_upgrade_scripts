UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/02/19-52-03.349_mkngff/bc114e50-e0f4-49ad-9025-ada12c1a1b57.zarr' where image in (select id from Image where fileset = 4053195);
