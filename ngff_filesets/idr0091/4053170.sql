UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/02/17-23-04.604_mkngff/842af068-68a7-4ed7-a953-8989d6b81fcc.zarr' where image in (select id from Image where fileset = 4053170);
