UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/14-43-15.289_mkngff/8cb4a802-1d97-46a7-9703-c573d4d5efeb.zarr' where image in (select id from Image where fileset = 4053502);
