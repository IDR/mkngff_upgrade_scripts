UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/13-07-11.617_mkngff/c2a908d6-30a1-494a-990f-ea8e22577d01.zarr' where image in (select id from Image where fileset = 6314337);
