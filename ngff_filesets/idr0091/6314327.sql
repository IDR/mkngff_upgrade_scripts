UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/00-46-34.200_mkngff/04c15415-12ee-4ba3-92c1-7f3c2666c7d9.zarr' where image in (select id from Image where fileset = 6314327);
