UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/18-11-11.534_mkngff/b49952ee-4316-45bf-981d-2a18853b4b17.zarr' where image in (select id from Image where fileset = 4053849);
