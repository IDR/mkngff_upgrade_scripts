UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/09-50-35.746_mkngff/0e3cc25c-9dde-4d5f-8604-676da18bc8ac.zarr' where image in (select id from Image where fileset = 6314242);
