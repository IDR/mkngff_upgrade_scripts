UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/02/19-19-59.558_mkngff/c6a39766-4360-4469-a83a-a397e64da93f.zarr' where image in (select id from Image where fileset = 6314356);
