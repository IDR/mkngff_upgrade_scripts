UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/02/20-17-22.165_mkngff/31ecc3b5-ce12-4ff5-ba91-d8aa9c2365b2.zarr' where image in (select id from Image where fileset = 4053198);
