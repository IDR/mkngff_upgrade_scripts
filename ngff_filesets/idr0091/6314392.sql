UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/11-49-30.153_mkngff/fe795db1-82c3-42b0-bbf8-5c4230bebdc9.zarr' where image in (select id from Image where fileset = 6314392);
