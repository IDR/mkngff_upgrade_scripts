UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/02/14-51-51.873_mkngff/4ea68fb7-2997-4071-a261-6725c952603f.zarr' where image in (select id from Image where fileset = 6314193);
