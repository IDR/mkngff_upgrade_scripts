UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/09-16-00.136_mkngff/8becd15a-dfbd-4463-992b-0d94969bcf99.zarr' where image in (select id from Image where fileset = 4053419);
