UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/18-25-15.176_mkngff/74c52152-c690-4c7c-b4eb-e8522f4df73d.zarr' where image in (select id from Image where fileset = 4053855);
