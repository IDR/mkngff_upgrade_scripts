UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/14-48-49.407_mkngff/2c6b2a59-5838-42ae-8798-420e9610cd17.zarr' where image in (select id from Image where fileset = 6314398);
