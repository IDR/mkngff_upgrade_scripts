UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/14-59-56.688_mkngff/46367b7b-38bd-4987-9718-c3a2367c0e81.zarr' where image in (select id from Image where fileset = 4053505);
