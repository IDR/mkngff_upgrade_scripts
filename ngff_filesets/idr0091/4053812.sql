UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/16-42-07.287_mkngff/af56c0ce-8860-4dfe-824d-69a80ce746f1.zarr' where image in (select id from Image where fileset = 4053812);
