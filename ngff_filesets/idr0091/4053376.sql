UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-16/2020-10/03/05-36-01.267_mkngff/ca71d333-fbeb-41c3-8c21-d5ce54d4c8bc.zarr' where image in (select id from Image where fileset = 4053376);
