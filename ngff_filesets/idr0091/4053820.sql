UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/03/17-01-14.232_mkngff/7bc5b9a6-da71-417f-8d71-00dc49231e70.zarr' where image in (select id from Image where fileset = 4053820);
