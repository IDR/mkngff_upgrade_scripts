UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/03/08-48-27.779_mkngff/44f85914-c3a3-47e5-bf25-5a2b71a99f83.zarr' where image in (select id from Image where fileset = 4053413);
