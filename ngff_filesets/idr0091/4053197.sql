UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/02/20-11-11.931_mkngff/0827acd5-6635-482e-975a-b68db893d110.zarr' where image in (select id from Image where fileset = 4053197);
