UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/11-12-22.117_mkngff/a7f7aabe-faae-4736-9cb1-1cae0134a06f.zarr' where image in (select id from Image where fileset = 4053448);
