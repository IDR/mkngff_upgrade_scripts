UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/12-51-04.703_mkngff/3a524090-e0b0-48ce-a090-505b72bacf5d.zarr' where image in (select id from Image where fileset = 6314305);
