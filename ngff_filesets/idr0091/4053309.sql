UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/02/22-23-41.504_mkngff/3d1cd506-c5e7-47da-a30b-72db86b9444a.zarr' where image in (select id from Image where fileset = 4053309);
