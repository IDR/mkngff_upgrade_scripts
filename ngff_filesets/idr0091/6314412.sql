UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/12-43-39.613_mkngff/c62cc1ce-c960-4b87-832e-e12cb6f04dce.zarr' where image in (select id from Image where fileset = 6314412);
