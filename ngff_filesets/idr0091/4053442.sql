UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/10-56-05.021_mkngff/3b09f5c8-a95b-490e-a8af-4795dc8bff15.zarr' where image in (select id from Image where fileset = 4053442);
