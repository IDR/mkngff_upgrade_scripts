UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/03/11-15-25.970_mkngff/bcd80654-84d4-486c-b08f-8da08f72748d.zarr' where image in (select id from Image where fileset = 6314288);
