UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/16-49-18.795_mkngff/9863ff42-ffa5-48e6-8abc-084b8c9ca8b9.zarr' where image in (select id from Image where fileset = 6314099);
