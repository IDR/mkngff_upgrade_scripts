UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-16/2020-10/03/01-21-53.154_mkngff/59f2eb22-7a1a-42cf-98e5-6c21a36e55f4.zarr' where image in (select id from Image where fileset = 4053340);
