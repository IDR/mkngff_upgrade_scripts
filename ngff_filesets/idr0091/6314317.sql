UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/02/16-12-36.384_mkngff/a08f63e3-d2a6-4e92-b925-edeea23725bc.zarr' where image in (select id from Image where fileset = 6314317);
