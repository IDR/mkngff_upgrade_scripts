UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/12-09-06.788_mkngff/4af22bbc-14d0-4438-9489-23f0cef308b0.zarr' where image in (select id from Image where fileset = 4053468);
