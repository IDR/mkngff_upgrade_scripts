UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/07-48-50.007_mkngff/ecb40903-cab2-43bb-a9b6-2620a43b783c.zarr' where image in (select id from Image where fileset = 6314237);
