UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/12-17-46.750_mkngff/1d60ef13-7e47-4705-a314-6048f2eb38ca.zarr' where image in (select id from Image where fileset = 4053471);
