UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-22/2020-10/03/09-02-48.751_mkngff/a2e5bfbd-60a0-4691-98f6-41d09fe86832.zarr' where image in (select id from Image where fileset = 4053416);
