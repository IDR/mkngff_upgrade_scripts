UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/16-13-41.608_mkngff/1c5ba5e8-100a-4593-ab5c-bac4d54b595c.zarr' where image in (select id from Image where fileset = 6314262);
