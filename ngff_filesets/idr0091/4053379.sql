UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-13/2020-10/03/05-57-00.310_mkngff/6c91b99c-b42f-4846-bcc1-43cfc656f44d.zarr' where image in (select id from Image where fileset = 4053379);
