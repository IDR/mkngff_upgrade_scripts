UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-7/2020-10/03/18-23-01.353_mkngff/0a410a0d-f258-4a74-8301-298292251ce7.zarr' where image in (select id from Image where fileset = 4053854);
