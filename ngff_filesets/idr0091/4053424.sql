UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/09-37-44.698_mkngff/069762d9-656f-401d-9383-ade9d886dbe2.zarr' where image in (select id from Image where fileset = 4053424);
