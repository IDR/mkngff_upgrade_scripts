UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/02/18-41-53.326_mkngff/fdfdbb32-c1c2-4eec-8bbd-ffc3b729958b.zarr' where image in (select id from Image where fileset = 6314352);
