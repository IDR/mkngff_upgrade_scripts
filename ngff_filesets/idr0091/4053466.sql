UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/12-03-21.706_mkngff/47b98760-bb85-4923-ba46-c31688ca9468.zarr' where image in (select id from Image where fileset = 4053466);
