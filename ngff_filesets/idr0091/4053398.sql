UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/03/08-10-15.383_mkngff/c375a12e-c5e0-4744-a9f3-bcfb86ec50a6.zarr' where image in (select id from Image where fileset = 4053398);
