UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-12/2020-10/02/21-06-18.740_mkngff/83aa6d4a-fcdd-4425-a69e-3510416140c7.zarr' where image in (select id from Image where fileset = 6314427);
