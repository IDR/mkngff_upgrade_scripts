UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-14/2020-10/03/16-58-50.639_mkngff/e650932b-2aa5-48f9-8fdb-df1c446d20c4.zarr' where image in (select id from Image where fileset = 4053819);
