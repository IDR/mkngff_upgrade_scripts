UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/02/23-08-40.514_mkngff/fac708b8-0b44-46aa-92e6-1d96b00eab91.zarr' where image in (select id from Image where fileset = 4053317);
