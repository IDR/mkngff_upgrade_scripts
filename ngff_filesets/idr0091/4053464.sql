UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-22/2020-10/03/11-57-28.518_mkngff/987f73d6-2215-4309-a000-74ca6109430f.zarr' where image in (select id from Image where fileset = 4053464);
