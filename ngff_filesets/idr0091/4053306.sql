UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/02/22-07-29.919_mkngff/d58dae8e-dfb8-40cb-b561-ec5c1f005e53.zarr' where image in (select id from Image where fileset = 4053306);
