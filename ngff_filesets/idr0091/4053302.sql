UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/02/21-45-49.458_mkngff/6d46766f-f2b2-4123-9d37-b649616a0df7.zarr' where image in (select id from Image where fileset = 4053302);
