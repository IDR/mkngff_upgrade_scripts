UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-18/2020-10/03/17-45-04.743_mkngff/3cba84f3-9fcb-4d66-80d5-e5f0f7b8bf7d.zarr' where image in (select id from Image where fileset = 6314410);
