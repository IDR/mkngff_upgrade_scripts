UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-10/2020-10/02/22-37-08.742_mkngff/bb35d8c6-08cb-4ff4-acce-9ce9c8a127ea.zarr' where image in (select id from Image where fileset = 4053312);
