UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/03-34-23.500_mkngff/f464178b-eef6-4c80-b2da-18a1e4a4dba9.zarr' where image in (select id from Image where fileset = 4053360);
