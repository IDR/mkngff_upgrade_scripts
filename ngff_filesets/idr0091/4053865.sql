UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/18-48-59.765_mkngff/0313c8dc-6c95-444a-8418-2bae3a4b781e.zarr' where image in (select id from Image where fileset = 4053865);
