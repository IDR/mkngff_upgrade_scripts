UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/16-16-06.199_mkngff/fe65c558-7099-48c4-8222-a5dc54da884a.zarr' where image in (select id from Image where fileset = 4053801);
