UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-19/2020-10/03/12-41-01.474_mkngff/9dc03f90-7aaa-436d-8b23-ec0fd665c5a5.zarr' where image in (select id from Image where fileset = 6314383);
