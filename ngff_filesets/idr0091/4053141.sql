UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-20/2020-10/02/14-46-33.031_mkngff/0346440c-6461-4347-a57c-1eb137e2f71d.zarr' where image in (select id from Image where fileset = 4053141);
