UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-21/2020-10/03/03-53-29.410_mkngff/79b52591-6a4f-4ec5-9d8c-088386991616.zarr' where image in (select id from Image where fileset = 6314211);
