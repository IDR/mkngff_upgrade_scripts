UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-11/2020-10/03/14-32-10.979_mkngff/5d7af982-c44b-47bc-84b8-af5df06dd38a.zarr' where image in (select id from Image where fileset = 6314313);
