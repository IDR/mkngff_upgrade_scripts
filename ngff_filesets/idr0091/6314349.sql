UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/03/01-29-07.519_mkngff/7b8b771d-5015-40b2-b136-c271b1d44893.zarr' where image in (select id from Image where fileset = 6314349);
