UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-2/2020-10/02/16-41-07.634_mkngff/f4ec2dee-1609-429f-96ac-e4efa9ddd533.zarr' where image in (select id from Image where fileset = 6314152);
