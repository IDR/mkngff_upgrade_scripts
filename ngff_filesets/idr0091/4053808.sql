UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-17/2020-10/03/16-33-01.974_mkngff/ac9e4cf1-7951-491a-9150-54b2cc4dd2e1.zarr' where image in (select id from Image where fileset = 4053808);
