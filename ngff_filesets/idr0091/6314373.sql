UPDATE pixels SET name = '.zattrs', path = 'demo_2/Blitz-0-Ice.ThreadPool.Server-5/2020-10/03/07-56-45.997_mkngff/ee13ad52-bcf3-4d03-961f-9da709194f26.zarr' where image in (select id from Image where fileset = 6314373);
